...
## Introducción
```
From the point of view of a company that has decided to use Stream Hatchet's BI I think it would be
useful to add a section where users could check easily which sponsors each streamer has, 
